...
fn main() {
    ...
    println!("Part 1: (21105) {}", part_1::solve(&lines));
    println!("Part 2: (5329815) {}", part_2::solve(&lines));
}
...
mod tests {
    ...
    fn test_part_1() {
        ...
        assert_eq!(21105, part_1::solve(&lines));
    }
    ...
    fn test_part_2() {
        ...
        assert_eq!(5329815, part_2::solve(&lines));
    }

    #[test]
    fn test_get_input_file_path() {
        assert_eq!("./src/day-4/src/input.txt", get_input_file_path());
    }
}
